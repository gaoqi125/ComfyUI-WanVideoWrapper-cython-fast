...
try:
    from .wanvideo_c_nodes_exact import NODE_CLASS_MAPPINGS as WANVIDEO_C_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as WANVIDEO_C_NODE_DISPLAY_NAME_MAPPINGS
    log.info("WanVideoWrapper: C Series nodes (exact replicas) loaded successfully")
    WANVIDEO_C_AVAILABLE = True
except Exception as e:
    log.warning(f"WanVideoWrapper WARNING: C Series nodes not available due to error in importing them: {e}")
    WANVIDEO_C_NODE_CLASS_MAPPINGS = {}
    WANVIDEO_C_NODE_DISPLAY_NAME_MAPPINGS = {}
    WANVIDEO_C_AVAILABLE = False

try:
    from .wanvideo_cython_nodes import NODE_CLASS_MAPPINGS as CYTHON_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as CYTHON_NODE_DISPLAY_NAME_MAPPINGS
    log.info("WanVideoWrapper: Cython compiled nodes loaded successfully")
    WANVIDEO_CYTHON_AVAILABLE = True
except Exception as e:
    log.warning(f"WanVideoWrapper WARNING: Cython nodes not available due to error in importing them: {e}")
    CYTHON_NODE_CLASS_MAPPINGS = {}
    CYTHON_NODE_DISPLAY_NAME_MAPPINGS = {}
    WANVIDEO_CYTHON_AVAILABLE = False
...
NODE_CLASS_MAPPINGS.update(WANVIDEO_C_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(CYTHON_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(WANVIDEO_C_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(CYTHON_NODE_DISPLAY_NAME_MAPPINGS)
